...
- If the project is too large for a single sprint, help the user decompose into sub-sprints: what are the independent pieces, how do they relate, what order should they be built? Then brainstorm the first sub-sprint through the normal design flow. Each sub-sprint gets its own design → sprint file → execution cycle.
...
3. **Scope check:** Is this focused enough for a single sprint, or does it need decomposition?
...
- Return the approved direction and spec path to sprint-army
- sprint-army will invoke `sprint-design` to convert the design into a concrete sprint file with tasks, dependencies, and quality level
